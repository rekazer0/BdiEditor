...
1. 点击左上角“打开”选择现有 `.bdi`、`.bds` 或 `.bda` 文件；也可点击“新建项目”，从百度官方 BDA 默认皮肤、官方 BDS 旧版皮肤、“仿ios15键”或内置“尘埃”模板开始。
...
- 百度官方 Android BDA 默认皮肤、官方 BDS 旧版皮肤、“仿ios15键”、4 套“尘埃”内置模板、新建皮肤、撤销/重做和未保存保护；
- 可选择默认、马赛克、白色或深色画布背景；
