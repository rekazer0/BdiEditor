...
assert.match(actionDescription("F10"), /首字母大写/)
assert.match(actionDescription("F11"), /大写锁定/)
assert.equal(previewStateTransitionFromAction("F10"), 1)
assert.equal(previewStateTransitionFromAction("F10", 1), null)
assert.equal(previewStateTransitionFromAction("F10", 2), 1)
assert.equal(previewStateTransitionFromAction("F11"), 2)
